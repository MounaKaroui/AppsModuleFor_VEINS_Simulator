//
// Generated file, do not edit! Created by nedtool 5.0 from veins/modules/messages/BasicSafetyMessage.msg.
//
...
BasicSafetyMessage::BasicSafetyMessage(const char *name, int kind) : ::WaveShortMessage(name,kind)
{
}
